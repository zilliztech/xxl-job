...
import com.xxl.job.admin.core.util.FeishuNoticeUtils;
...
public class EmailJobAlarm implements JobAlarm {
    ...
    public boolean doAlarm(XxlJobInfo info, XxlJobLog jobLog) {
        ...
        if (info != null && info.getAlarmEmail() != null && info.getAlarmEmail().trim().length() > 0) {
            ...
            // alarmContent
            String alarmContent = "Alarm Job LogId=" + jobLog.getId() + System.lineSeparator();
            ...
            String content = MessageFormat.format(loadFeishuTemplate(),
...
//                    XxlJobAdminConfig.getAdminConfig().getMailSender().send(mimeMessage);
                    ...
                    FeishuNoticeUtils.sendTextMessage(email, content);
